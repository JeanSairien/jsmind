...
if (document.layers || document.all)
  {
  scrollAuto()
  console.log('see 3.Multi Format')
  }
...
<div id="layout">
    <div id="jsmind_nav">
        ...
        <ol type='A'>
            ...
            <li><button href="#multi" onclick="scrollAuto();">open local file</button></li>
            <li><button onclick="prompt_info('see 3.Multi Format');">save local file</button></li>
        ...
        <ol type='A'>
         ...
         <div id="multi">3. Multi Format</div>
        <ol type='A'>
